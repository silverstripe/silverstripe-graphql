...
abstract class AbstractQueryFilterPlugin implements QueryPlugin, SchemaUpdater
{
    use Configurable;
     ...
     * @return array
     */
    abstract protected function getFilterResolver(): array;
     ...
     * @return array
     */
    private static function buildPathsFromFieldMapping(
        array $mapping,
        array $fieldOrigin = [],
        array $propOrigin = []
    ): array {
        ...
        foreach ($mapping as $fieldName => $config) {
            ...
            $prop = static::getFilterableField($config['class'], $fieldName);
     ...
     * @return string
     */
    protected static function inputTypeName(string $internalType): string
    {
