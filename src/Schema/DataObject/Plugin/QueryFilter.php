...
class QueryFilter extends AbstractQueryFilterPlugin
{
     ...
     * @return array
     */
    protected function getFilterResolver(): array
    {
     ...
     * @return string|null
     */
    protected static function getFilterableField(string $class, string $fieldName): ?string
    {
        $sng = DataObject::singleton($class);
        return FieldAccessor::singleton()->normaliseField($sng, $fieldName);
    }
